...
```bash
python scripts/geo_orbital_newton_vs_geo.py
```

```bash
python scripts/geo_orbital_formula_diagnostic.py
```
...
- `geo_force_ratio.png`
- `geo_rosette_phase_colormap.png`
- `geo_phase_gap_brake.png`
- `geo_curvature_proxy.png`
